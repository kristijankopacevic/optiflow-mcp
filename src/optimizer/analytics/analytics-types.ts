// Ported verbatim from vendor/token-optimizer-mcp/src/analytics/analytics-types.ts
// (MIT-licensed -- see THIRD_PARTY_LICENSES.md). Pure type definitions, no
// hardcoded paths, nothing to reconcile.
