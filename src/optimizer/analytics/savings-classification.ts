...
// vendor/token-optimizer-mcp/src/analytics/savings-classification.ts
// (MIT-licensed -- see THIRD_PARTY_LICENSES.md). Pure classification logic
// over an AnalyticsEntry, no I/O, no hardcoded paths.
