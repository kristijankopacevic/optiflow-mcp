...
class HealthCheckExecutor {
  ...
  private async executeHttpCheck(
    ...
    // Same on-demand, self-clearing timer as health-monitor.ts's identical
    // executeHttpCheck -- unref'd for the same hygiene reason (see that
    // file's own comment here).
