...
mod tests {
    ...
    fn shared_python_rust_policy_vectors() {
        ...
        // "../../../tests/fixtures/..." reached the headroom workspace
        // root's shared Python/Rust parity fixtures directory from
        // crates/headroom-core/src/. This fork copies the same fixture to
        // tests/fixtures/ directly under this crate (one level up from
        // src/, not three) since there's no workspace root to reach.
